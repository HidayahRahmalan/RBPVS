...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tarikh_due = $_POST['tarikhDue']; // Assuming the date format is compatible with your database
    $jenis_tugasan = $_POST['jenisTugasan'];
    $sk_id = intval($_POST['skIDForTugasan']);
    ...
    $sql = "INSERT INTO tugasan (nama_tugasan, deskripsi_tugasan, jenis_tugasan, lampiran_path, tarikh_due, sk_id) 
            VALUES ('$nama_tugasan', '$deskripsi_tugasan', '$jenis_tugasan', '$lampiran_path', '$tarikh_due', $sk_id)";
