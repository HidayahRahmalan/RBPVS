...
<table id="myTable" class="table table-striped table-bordered" style="background-color: #f0f0f0;">
    ...
    <tbody>
        <?php while ($row_kumpulan_submission = $result_kumpulan_submission->fetch_assoc()): ?>
            <tr>
                <td><?= $row_kumpulan_submission["nama_kumpulan"] ?></td>
                <td><?= ($row_kumpulan_submission["tarikh_penyerahan"] != '0000-00-00' && $row_kumpulan_submission["tarikh_penyerahan"] != null) ? date("d F Y", strtotime($row_kumpulan_submission["tarikh_penyerahan"])) : '<center>-</center>' ?></td>
                <td>
                    <?php if (!empty($row_kumpulan_submission["penyerahan_path"])): ?>
                        <a href="<?= $row_kumpulan_submission["penyerahan_path"] ?>" target="_blank">Lihat Fail</a>
                    <?php else: ?>
                        <center>-</center>
                    <?php endif; ?>
                </td>
...
<button type='button' class='btn btn-primary btn-sm' 
        ...
        data-rubrik-id="<?= $row_kumpulan_submission['rubrik_id'] ?>">
  Edit Markah
</button>
                    <?php
                } else {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="nilai-form">
          ...
          <input type="hidden" id="nama-kumpulan" name="nama_kumpulan">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="edit-markah-form">
          ...
          <input type="hidden" id="nama-kumpulan-edit" name="nama_kumpulan">
...
// Handle 'Beri Nilai' button click to set penyerahan_id, nama_kumpulan, and rubrik_id in the modal
$('#beriNilaiModal').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-body #nama-kumpulan').val(nama_kumpulan);
...
// Handle 'Edit Markah' button click to set penyerahan_id, nama_kumpulan, and rubrik_id in the modal
$('#editMarkahModal').on('show.bs.modal', function (event) {
    ...
    modal.find('.modal-body #nama-kumpulan-edit').val(nama_kumpulan);
