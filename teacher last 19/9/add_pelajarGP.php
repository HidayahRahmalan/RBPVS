...
<div class="container-fluid">
    <div class="row">
        ...
        <a href='kumpulan.php' class='btn btn-secondary btn-sm'>Kembali</a>
            <h1 class="text-center mb-4">Tambah/Edit Pelajar Kumpulan</h1>
        ...
        <div class="card-body"> 
            ...
            <form id="assignStudentsForm">
                ...
                <div class="form-group">
                    <label for="availableStudents">Available Pelaajr:</label>
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-success" id="assignButton">Assign <i class="fas fa-arrow-right"></i></button>
