    ...
    <tbody>
        <?php while ($row_pelajar_submission = $result_pelajar_submission->fetch_assoc()): ?>
            <tr>
                ...
                <td><?= ($row_pelajar_submission["tarikh_penyerahan"] != '0000-00-00' && $row_pelajar_submission["tarikh_penyerahan"] != null) ? date("d F Y", strtotime($row_pelajar_submission["tarikh_penyerahan"])) : '<center>-</center>' ?></td>
                <td>
