...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $kandungan_kuiz_id = intval($_POST['kandungan_kuiz_id']);
    ...
    $sql_original_path = "SELECT kandungan_path FROM kandungan_kuiz WHERE kandungan_kuiz_id = $kandungan_kuiz_id";
    ...
    $sql = "UPDATE kandungan_kuiz 
            ...
            WHERE kandungan_kuiz_id = $kandungan_kuiz_id";
