...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT kandungan_path FROM KANDUNGAN_tugasan WHERE kandungan_tugasan_id = '$kandungan_tugasan_id'";
    ...
    $sql = "DELETE FROM KANDUNGAN_TUGASAN WHERE kandungan_tugasan_id = '$kandungan_tugasan_id'";
