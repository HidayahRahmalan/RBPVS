...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kandungan_tugasan (deskripsi_kandungan, pautan_url, kandungan_path, urutan_kandungan, tugasan_id) 
            VALUES ('$deskripsi_kandungan', '$pautanURL', '$kandungan_path', $urutan_kandungan, $tugasan_id)"; 
