...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_original_path = "SELECT kandungan_path FROM kandungan_tugasan WHERE kandungan_tugasan_id = $kandungan_tugasan_id";
    ...
    $sql = "UPDATE kandungan_tugasan 
            ...
            WHERE kandungan_tugasan_id = $kandungan_tugasan_id";
