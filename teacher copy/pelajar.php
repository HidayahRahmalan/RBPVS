...
<div class="container-fluid vh-100 d-flex flex-column"> 
    ...
    <div class="card shadow h-100 rounded-3">
        <div class="card-body d-flex flex-column align-items-center"> 
            <h4 class="card-title mb-0">4 Bestari</h4> 
            <p class="card-text text-muted">25 Pelajar</p>
            <a href="pelajar_senaraiPljr.php?kelas_id=1" class="btn btn-primary mt-3">Lihat Pelajar</a> 
        </div>
    </div>
</div>
</div>
