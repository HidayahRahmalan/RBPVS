        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-body p-4">
                    <h1 class="display-4 mb-3">Selamat Datang, Cikgu Haziq!</h1>
                    <hr class="my-4">
                    <p>Mari mulakan pengembaraan Reka Bentuk Teknologi bersama pelajar anda!</p> 
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow">
                <div class="card-body d-flex flex-column align-items-center p-4">
                    ...
                    <h5 class="card-title">Projek RBT</h5>
                    <ul class="list-group list-group-flush w-100">
                        <li class="list-group-item">Reka Bentuk Bekas Pensil</li>
                        <li class="list-group-item">Model Jambatan Kukuh</li>
                    </ul>
                    <a href="#" class="btn btn-primary mt-3">Lihat Semua</a> 
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow">
                <div class="card-body d-flex flex-column align-items-center p-4">
                    ...
                    <h5 class="card-title">Jadual Hari Ini</h5>
                    <ul class="list-group list-group-flush w-100">
                        <li class="list-group-item">08:00 - 09:30 | 4 Bestari | RBT</li>
                        <li class="list-group-item">14:00 - 15:30 | 5 Inovatif | RBT</li>
                    </ul>
                    <a href="#" class="btn btn-primary mt-3">Lihat Jadual Penuh</a> 
                </div>
            </div>
        </div>
    </div>
