...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk) {
        ...
        if ($jenis_tugasan == 'individu') {
            ...
            $sql = "INSERT INTO penyerahan (pelajar_id, tugasan_id, penyerahan_path1, tarikh_penyerahan1) 
    ...
    if ($result_submission->num_rows > 0) {
        ...
        $sql = "INSERT INTO penyerahan (kumpulan_id, tugasan_id, penyerahan_path1, tarikh_penyerahan1) 
                VALUES ($kumpulan_id, $tugasan_id, '$file_path', NOW())";
